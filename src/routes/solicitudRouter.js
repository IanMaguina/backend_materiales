...
router.post('/:id_solicitud/materialSolicitud/crearAmpliacion', materialSolicitudController.external.agregarAmpliacion);
...
router.post('/:id_solicitud/materialSolicitud/crearModificacion', materialSolicitudController.external.agregarModificacion);
...
router.post('/:id_solicitud/materialSolicitud/crearBloqueo', materialSolicitudController.external.agregarBloqueo);
